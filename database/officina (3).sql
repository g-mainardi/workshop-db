...
--
-- Host: 127.0.0.1
-- Creato il: Dic 15, 2022 alle 14:39
...
(1, 'Sandalo', 23, '', 20),
(2, 'Sportello', 23, 'Lo sportello dell\'auto', 300),
(3, 'Sportello', 2, 'sportello fiat stilo per ricambi ottenut', 20);
...
('NNALDE95L41F717A', 2, '2022-12-12', '2022-12-14', 500, 6),
('DGRSFN06D01C685N', 3, '2022-11-09', '2022-12-15', 500, 7),
('VLLLZG73P41D628B', 6, '2022-12-02', '2022-12-10', 500, 8),
('BSTDMR84H01C046C', 5, '2022-12-16', '2022-12-20', 600, 9);
...
(16, 'KIA', 'Sportage', 2002, '1250'),
(17, 'Jeep', 'renegade', 2018, '3000'),
(18, 'Audi', 'A6', 2009, '4000');
...
--
ALTER TABLE `pezzo_ricambio`
  MODIFY `id_pezzo` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT per la tabella `riparazione`
--
ALTER TABLE `riparazione`
  MODIFY `id_riparazione` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `veicolo`
  MODIFY `cod_veicolo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
COMMIT;
