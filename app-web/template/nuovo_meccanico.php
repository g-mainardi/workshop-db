...
<section class="tabelle">
	...
	<table>
		...
		<tbody>
			...
			<form action="#" method="POST">
				<tr>
					<td><input type="hidden" name="meccanicoCF" value=<?php echo $meccanico["CF"]; ?>> <?php echo $meccanico["CF"]?></td>
					...
					<td><input type="email" maxlength="80" name="meccanicoMail" placeholder="Inserisci email" value=<?php echo $meccanico["mail"]?>></td>
					<td><input type="number" min="1" name="meccanicoPaga" placeholder="Inserisci paga oraria" value=<?php echo $meccanico["paga"]?> required></td>
