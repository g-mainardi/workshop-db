<section class="prova">
	<ul>
        <li>
			<a href="gestione_meccanici.php">MECCANICI</a>
		...
		<li>
			<a href="gestione_pezzi.php">PEZZI</a>
			<p>Qui puoi visualizzare la lista dei pezzi di ricambio e inserirne di nuovi</p>
		</li>
	</ul>
</section>