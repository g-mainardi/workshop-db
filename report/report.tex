...
\begin{figure}[H]
	...
	\begin{tabular}{l c c }
		...
		\hline\rule[-3mm]{0mm}{0.85cm}
		Cliente & Utente Proprietario & \quantities{Persona che deve eseguire o ha eseguito una \\riparazione o una transazione con l'officina. }\\
		\hline\rule[-3mm]{0mm}{0.85cm}
...
\addcontentsline{toc}{section}{SchemaR relazionale finale}	
	\begin{figure}[H]
		\centering
...
\addcontentsline{toc}{section}{Pagina iniziale}	
	\begin{figure}[H]
		\centering
...
\addcontentsline{toc}{section}{Clienti}	
	\begin{figure}[H]
		\centering
...
\begin{itemize}
	...
	\addcontentsline{toc}{section}{Agenti}	
	\begin{figure}[H]
		\centering
	...
	\addcontentsline{toc}{section}{Transazioni}	
	\begin{figure}[H]
		\centering
...
\begin{itemize}
	...
	\addcontentsline{toc}{section}{Meccanici}	
	\begin{figure}[H]
		\centering
	...
	Si può notare inoltre che sotto il form d'inserimento ce n'è un altro per poter visualizzare le Case di Produzione 
	%
	le cui auto hanno avuto più riparazioni in uno specifico anno.
	\addcontentsline{toc}{section}{Riparazioni}	
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.5]{img/riparazioni.jpg}
	\end{figure}

	\item \textbf{Pagina Pezzi di ricambio}
...
\begin{itemize}
	...
	\addcontentsline{toc}{section}{Veicoli Nuovi}	
	\begin{figure}[H]
		\centering
	...
	\addcontentsline{toc}{section}{Veicoli Usati}	
	\begin{figure}[H]
		\centering
